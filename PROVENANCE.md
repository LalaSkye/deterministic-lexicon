...
**Repository:** deterministic-lexicon
**Purpose:** Fixed vocabulary primitive — exact-match lookups, frozen after construction, no inference, no synonyms.
...
**Public (this repository):** Full implementation (~100 LOC), test suite, API.

**Private (withheld by design):** Production vocabulary definitions used in governance pipeline.
